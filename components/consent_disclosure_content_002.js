    ...
    return (
      <View>
        ...
        <View style={styles.elevated}>
          ...
          <Text style={styles.text}>
            For mothers with children, we are asking your consent to access your
            baby’s newborn screening blood spots for genetic testing purposes
            (blood spots are obtained from all babies born in the State of
            Iowa). You are requested to give permission to use the blood spot in
            this research study.
          </Text>
          <Text style={styles.text}>
