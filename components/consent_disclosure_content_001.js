...
class ConsentDisclosureContent001 extends Component {
  state = {
    showItem: '',
  };
    ...
    return (
      <View>
        ...
        <View style={styles.elevated}>
          ...
          <Text style={styles.text}>This is a research study.</Text>
          <Text style={styles.text}>
...
export default connect(mapStateToProps)(ConsentDisclosureContent001);